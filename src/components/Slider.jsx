...
//     <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-3 px-2">
//       <div className="w-full md:w-[75%] lg:w-[90%] overflow-hidden rounded-md shadow-sm">
//         <Carousel 
//           autoplay 
//           autoplaySpeed={2000} 
//           arrows 
...
//             <div key={index}>
//               <div className="h-80 md:h-96 lg:h-screen w-full">
//                 <img 
//                   src={img} 
//                   alt={`Slide ${index + 1}`} 
